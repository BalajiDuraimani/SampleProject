...
public class CreateLead extends ProjectSpecificWrappers{
	...
	//@Test(groups= {"all"},dataProvider = "fetchdata",invocationCount=20)
	@Test(groups= {"all"},invocationCount=20)
//	public void createrlead(String companyname, String firstname,String lastname){		
